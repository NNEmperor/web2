...
export class NewIncidentMultimediaComponent implements OnInit {
  ...
  constructor(private sanitizer: DomSanitizer, private service: MessagePassingService,private router: Router, private http:HttpClient, notifierService: NotifierService) {
  ...
  SaveImages(){
    ...
    //add the file obj to your array
      ...
      this.service.sendIncidentMedia(formData);
